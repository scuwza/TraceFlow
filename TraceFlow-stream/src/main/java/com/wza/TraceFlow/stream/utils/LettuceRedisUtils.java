package com.wza.TraceFlow.stream.utils;

import com.wza.TraceFlow.stream.callback.RedisPipelineCallBack;
...
public class LettuceRedisUtils {
    ...
    static {
        RedisURI redisUri = RedisURI.Builder.redis(TraceFlowFlinkConstant.REDIS_IP)
                .withPort(Integer.valueOf(TraceFlowFlinkConstant.REDIS_PORT))
                .withPassword(TraceFlowFlinkConstant.REDIS_PASSWORD.toCharArray())
                .build();
