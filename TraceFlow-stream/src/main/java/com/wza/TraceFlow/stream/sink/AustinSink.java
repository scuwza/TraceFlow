package com.wza.TraceFlow.stream.sink;
...
import com.wza.TraceFlow.stream.utils.LettuceRedisUtils;
 ...
 */
@Slf4j
public class TraceFlowSink implements SinkFunction<AnchorInfo> {
    ...
    private void realTimeData(AnchorInfo info) {
        try {
            ...
            log.error("TraceFlowSink#invoke error: {}", Throwables.getStackTraceAsString(e));
        }
    }
