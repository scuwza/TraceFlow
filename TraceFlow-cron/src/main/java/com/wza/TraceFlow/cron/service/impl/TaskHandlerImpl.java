package com.wza.TraceFlow.cron.service.impl;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.text.csv.CsvRow;
import cn.hutool.core.util.StrUtil;
import com.wza.TraceFlow.cron.csv.CountFileRowHandler;
import com.wza.TraceFlow.cron.pending.CrowdBatchTaskPending;
import com.wza.TraceFlow.cron.service.TaskHandler;
import com.wza.TraceFlow.cron.utils.ReadFileUtils;
import com.wza.TraceFlow.cron.vo.CrowdInfoVo;
import com.wza.TraceFlow.support.dao.MessageTemplateDao;
import com.wza.TraceFlow.support.domain.MessageTemplate;
import com.wza.TraceFlow.support.pending.AbstractLazyPending;
...
public class TaskHandlerImpl implements TaskHandler {
    ...
    public void handle(Long messageTemplateId) {
        ...
        // 1. 获取文件行数大小
        // CronCrowdPath是创建messageTemplate时指定的
