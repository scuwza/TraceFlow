package com.wza.TraceFlow.cron.pending;
...
import com.wza.TraceFlow.cron.config.CronAsyncThreadPoolConfig;
import com.wza.TraceFlow.cron.constants.PendingConstant;
...
import com.wza.TraceFlow.support.pending.PendingParam;
...
public class CrowdBatchTaskPending extends AbstractLazyPending<CrowdInfoVo> {
    ...
    public CrowdBatchTaskPending() {
        ...
        pendingParam.setQueue(new LinkedBlockingQueue(PendingConstant.QUEUE_SIZE))
                ...
                .setNumThreshold(TraceFlowConstant.BATCH_RECEIVER_SIZE)
