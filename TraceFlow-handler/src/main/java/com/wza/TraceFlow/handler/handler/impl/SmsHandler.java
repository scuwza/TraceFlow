...
import com.wza.TraceFlow.common.dto.model.SmsContentModel;
import com.wza.TraceFlow.common.enums.ChannelType;
import com.wza.TraceFlow.handler.domain.sms.MessageTypeSmsConfig;
...
public class SmsHandler extends BaseHandler implements Handler {
    ...
    private List<MessageTypeSmsConfig> getMessageTypeSmsConfig(Integer msgType) {
        ...
        for (int i = 0; i < jsonArray.size(); i++) {
            // [{"weights":80,"scriptName":"TencentSmsScript"},{"weights":20,"scriptName":"YunPianSmsScript"}]
