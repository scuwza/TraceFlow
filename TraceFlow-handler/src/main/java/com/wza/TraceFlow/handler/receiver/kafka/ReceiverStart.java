...
public class ReceiverStart {
     ...
     */
    @Bean
    public ConcurrentKafkaListenerContainerFactory filterContainerFactory(@Value("${TraceFlow.business.tagId.key}") String tagIdKey,
                                                                          @Value("${TraceFlow.business.tagId.value}") String tagIdValue) {
