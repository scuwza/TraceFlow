...
import com.wza.TraceFlow.common.domain.LogParam;
import com.wza.TraceFlow.common.domain.TaskInfo;
import com.wza.TraceFlow.common.dto.account.DingDingWorkNoticeAccount;
import com.wza.TraceFlow.common.dto.model.DingDingWorkContentModel;
import com.wza.TraceFlow.common.enums.ChannelType;
import com.wza.TraceFlow.common.enums.SendMessageType;
import com.wza.TraceFlow.handler.handler.BaseHandler;
import com.wza.TraceFlow.handler.handler.Handler;
import com.wza.TraceFlow.support.config.SupportThreadPoolConfig;
...
public class DingDingWorkNoticeHandler extends BaseHandler implements Handler {
    ...
    public boolean handler(TaskInfo taskInfo) {
        try {
            ...
            // 常见的错误 应当 关联至 AnchorState,由TraceFlow后台统一透出失败原因
    ...
    private OapiMessageCorpconversationAsyncsendV2Request assembleParam(DingDingWorkNoticeAccount account, TaskInfo taskInfo) {
        ...
        try {
            // 接收者相关
            if (TraceFlowConstant.SEND_ALL.equals(CollUtil.getFirst(taskInfo.getReceiver()))) {
