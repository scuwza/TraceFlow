...
public class NacosUtils {
    @Value("${TraceFlow.nacos.server}")
    private String nacosServer;
    @Value("${TraceFlow.nacos.username}")
    private String nacosUsername;
    @Value("${TraceFlow.nacos.password}")
    private String nacosPassword;
    @Value("${TraceFlow.nacos.group}")
    private String nacosGroup;
    @Value("${TraceFlow.nacos.dataId}")
    private String nacosDataId;
    @Value("${TraceFlow.nacos.namespace}")
