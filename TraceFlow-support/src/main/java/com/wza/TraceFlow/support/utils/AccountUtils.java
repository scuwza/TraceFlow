package com.wza.TraceFlow.support.utils;
...
import com.wza.TraceFlow.common.dto.account.WeChatMiniProgramAccount;
...
public class AccountUtils {
     ...
     * @return
     */
    public <T> T getAccountById(Integer sendAccountId, Class<T> clazz) { //clazz = WxCpDefaultConfigImpl
        try {
