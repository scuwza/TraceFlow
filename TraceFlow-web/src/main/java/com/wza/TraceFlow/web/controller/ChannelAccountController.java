...
import com.wza.TraceFlow.web.service.ChannelAccountService;
import com.wza.TraceFlow.web.utils.Convert4Amis;
import com.wza.TraceFlow.web.utils.LoginUtils;
...
public class ChannelAccountController {
    ...
    public BasicResultVO saveOrUpdate(@RequestBody ChannelAccount channelAccount) {
        ...
        channelAccount.setCreator(StrUtil.isBlank(channelAccount.getCreator()) ? TraceFlowConstant.DEFAULT_CREATOR : channelAccount.getCreator());
    ...
    public BasicResultVO query(Integer channelType, String creator) {
        ...
        creator = StrUtil.isBlank(creator) ? TraceFlowConstant.DEFAULT_CREATOR : creator;
