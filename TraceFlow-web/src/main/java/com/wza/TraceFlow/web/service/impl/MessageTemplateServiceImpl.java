...
import com.wza.TraceFlow.common.enums.AuditStatus;
import com.wza.TraceFlow.common.enums.MessageStatus;
import com.wza.TraceFlow.common.enums.RespStatusEnum;
import com.wza.TraceFlow.common.enums.TemplateType;
import com.wza.TraceFlow.common.vo.BasicResultVO;
import com.wza.TraceFlow.cron.xxl.entity.XxlJobInfo;
import com.wza.TraceFlow.cron.xxl.service.CronTaskService;
import com.wza.TraceFlow.cron.xxl.utils.XxlJobUtils;
import com.wza.TraceFlow.support.dao.MessageTemplateDao;
import com.wza.TraceFlow.support.domain.MessageTemplate;
import com.wza.TraceFlow.web.service.MessageTemplateService;
import com.wza.TraceFlow.web.vo.MessageTemplateParam;
...
public class MessageTemplateServiceImpl implements MessageTemplateService {
    ...
    public Page<MessageTemplate> queryList(MessageTemplateParam param) {
        ...
        String creator = StrUtil.isBlank(param.getCreator()) ? TraceFlowConstant.DEFAULT_CREATOR : param.getCreator();
    ...
    private void initStatus(MessageTemplate messageTemplate) {
        messageTemplate.setFlowId(StrUtil.EMPTY)
                ...
                .setCreator(StrUtil.isBlank(messageTemplate.getCreator()) ? TraceFlowConstant.DEFAULT_CREATOR : messageTemplate.getCreator())
                .setUpdator(StrUtil.isBlank(messageTemplate.getUpdator()) ? TraceFlowConstant.DEFAULT_UPDATOR : messageTemplate.getUpdator())
                .setTeam(StrUtil.isBlank(messageTemplate.getTeam()) ? TraceFlowConstant.DEFAULT_TEAM : messageTemplate.getTeam())
                .setAuditor(StrUtil.isBlank(messageTemplate.getAuditor()) ? TraceFlowConstant.DEFAULT_AUDITOR : messageTemplate.getAuditor())
