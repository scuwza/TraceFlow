package com.wza.TraceFlow.web.config;

import com.wza.TraceFlow.common.constant.OfficialAccountParamConstant;
import com.wza.TraceFlow.common.dto.account.WeChatOfficialAccount;
...
@ConditionalOnProperty(name = "TraceFlow.login.official.account.enable", havingValue = "true")
@Data
public class WeChatLoginConfig {

    @Value("${TraceFlow.login.official.account.appId}")
    private String appId;
    @Value("${TraceFlow.login.official.account.secret}")
    private String secret;
    @Value("${TraceFlow.login.official.account.token}")
